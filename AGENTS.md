...
- Tolerated dead code exists by user decision. Do not "clean it up" unless asked: what must stay is the 禁清理项 section of `.dev/docs/upstream-divergence.md`, and what may be cleaned later plus known defects is `.dev/docs/known-residue.md`.
